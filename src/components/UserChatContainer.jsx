    ...
    return (
        ...
        >
            ...
            >
                ...
                {
                    blockedYou.has(id) && <div style={blockedStyle}><h1>You are blocked by this user</h1></div>
                }
                {
                    youBlocked.has(id) && <div style={blockedStyle}><h1>You blocked this user</h1></div>
                }
